# -*- coding: utf-8 -*-
"""
Created on Sun Jul 12 20:34:30 2020
...
#Ajustar el modelo de Regresion logistica  de entrenamiento
from sklearn.linear_model import LogisticRegression
clasificador = LogisticRegression(random_state = 0) #Clasificador
clasificador.fit(X_train, y_train) #Aplicado a los datos
...
plt.title('Clasificador del conjunto train')
plt.xlabel('Edad')
plt.ylabel('Sueldo')
plt.legend()
plt.show
